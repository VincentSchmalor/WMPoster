...
glm.drei.Sterne <- glm(Budget ~ Alter + gift.count + wertschaetzung + GPM, data = training)
...
#Test
```{r}
gf_point(Budget ~ Alter, data = anwendung, colour = ~ gift.count, title = "Budget je Altersgruppe")
```
