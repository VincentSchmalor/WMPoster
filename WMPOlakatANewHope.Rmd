...
gf_boxplot(Budget ~ 1, data = DST.raw.extra)
```
...
Im vorigen Kapitel wurden relevante Korrelationen ausgewählt. Im Folgenden werden drei Relationen in linearen modellen beispielhaft visualisiert. Für die Skalenniveaus der kategoriellen (Likertskala), der binären und der numerischen Variablen wird je ein Modell dargestellt.
...
Die Grafiken zeigen, dass die Differenz, die Varianz und die Standardabweichung des erstellten Modells in allen Fällen unter denen des Nullmodells liegen.
